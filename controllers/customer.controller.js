...
exports.findAll = async (req, res) => {
  ...
  try {
    ...
    console.log("Success in reading all customers");
    // logger.info("Log info success in reading all customers");
    // // logger.log("Logger success in reading all customers");
  } catch (err) {
    res.status(400).json({ status: false, data: err });
    // logger.error("Problem in reading all customers");
